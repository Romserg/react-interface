  ...
  return (
    <div className="App container mx-auto mt-3 font-thin">
      <h1 className="text-5xl mb-3">
        <BiCalendar className="inline-block text-red-300" />Your Appointments</h1>
      <AddAppointment
      ...
      <Search query={query}
              ...
              orderBy={orderBy}
              onOrderByChange={customOrder => setOrderBy(customOrder)}
              sortBy={sortBy}
              onSortByChange={customSort => setSortBy(customSort)}
      />
